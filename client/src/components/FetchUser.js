...
ProtectedRoute is going to see if there user render the component if not redirect to login

*/
}

// FetchUser - is going to try to Fetch or see if we have a valid token/user
